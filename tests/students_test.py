...
def existing_student():
    # fetching an existing Student from the database
...
def test_post_assignment_student_1(client, h_student_1):
    ...
    # Trigger __repr__ by logging the assignment instance
    assignment = Assignment.get_by_id(data['id'])
    logging.debug(f'Assignment repr: {assignment}')
